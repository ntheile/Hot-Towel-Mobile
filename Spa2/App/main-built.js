...
function boot(e,t,n){function i(){e.start().then(function(){toastr.options.positionClass="toast-bottom-right",toastr.options.backgroundpositionClass="toast-bottom-right",toastr.info("Platform: "+e.platform+", isInitialized: "+e.isInitialized),t.useConvention(),e.isInitialized||(e.isInitialized=!0,e.setRoot("viewmodels/shell","entrance"))})}require(["services/binding-handlers"]),n.debug(!0),e.title="Hot Towel Mobile",e.configurePlugins({router:!0}),e.usePhonegap=!1,e.usePhonegap?document.addEventListener("deviceready",function(){e.platform=device.platform,i()},!1):(e.platform="web",i()),console.log(e)}require.config({paths:{text:"../Scripts/text",durandal:"../Scripts/durandal",plugins:"../Scripts/durandal/plugins",transitions:"../Scripts/durandal/transitions"}}),define("jquery",[],function(){return jQuery}),define("knockout",ko),define('main',["durandal/app","durandal/viewLocator","durandal/system","plugins/router","services/logger"],boot);
define('viewmodels/details',["services/logger","durandal/composition","durandal/app"],function(e,t,n){function i(){return e.log(o+" View Activated",null,o,!0),!0}function r(){n.isInitialized=!0,toastr.info("Deactived called")}var o="Details",a={activate:i,title:o,deactivate:r,composition:t};return a});
define('viewmodels/home',["services/logger","durandal/app"],function(e,t){function n(){return e.log(r+" View Activated",null,r,!0),!0}function i(){t.isInitialized=!0,toastr.info("Deactived called")}var r="Home",o={activate:n,deactivate:i,title:r};return o});
