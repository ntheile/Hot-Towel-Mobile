...
require.config({
    ...
    shim: {
        ...
        //    "deps": ["../Scriptsjquery-1.9.1", "jquery", "text"],
        //    "exports": "mmenu"
        //}
...
define('knockout', ko);
define(['../Scripts/jquery-1.9.1', '../Scripts/knockout-2.3.0.debug',
        '../Scripts/toastr', '../Scripts/Q', '../Scripts/breeze.debug',
        '../Scripts/bootstrap', '../Scripts/moment',
        '../Scripts/chosen.jquery.min', '../Scripts/jquery.mmenu.min']);
