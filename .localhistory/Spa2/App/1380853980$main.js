...
define(['jQuery', 'ko', 'toastr', 'Q', 'breeze', 'bootstrap', 'moment', 'chosen', 'mmenu', 
    'durandal/app', 'durandal/viewLocator', 'durandal/system', 'plugins/router', 'services/logger'], boot);

function boot(jQuery, ko, toastr, Q, breeze, bootstrap, moment, chosen, mmenu,
