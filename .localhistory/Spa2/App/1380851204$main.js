...
require('../Scripts/jquery-1.9.1', jQuery);
require('../Scripts/knockout-2.3.0.debug', ko);
require('../Scripts/toastr', toastr);
require('../Scripts/Q', Q);
require('../Scripts/breeze.debug', breeze);
require('../Scripts/bootstrap', bootstrap);
require('../Scripts/moment', moment);
require('../Scripts/chosen.jquery.min', chosen);
require('../Scripts/jquery.mmenu.min', mmenu);
