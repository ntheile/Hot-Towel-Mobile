...
define(['durandal/app', 'durandal/viewLocator', 'durandal/system', 'plugins/router', 'services/logger', '../Scripts/cordova'], boot);

function boot (app, viewLocator, system, router, logger, cordova) {
