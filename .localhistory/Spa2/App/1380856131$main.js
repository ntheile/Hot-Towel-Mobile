...
require(['jQuery', 'ko', 'toastr', 'Q', 'breeze', 'bootstrap', 'moment', 'chosen', 'mmenu'],
      function (jQuery, ko, toastr, Q, breeze, bootstrap, moment, chosen, mmenu) {
...
define(startIt, ['durandal/app', 'durandal/viewLocator', 'durandal/system', 'plugins/router', 'services/logger'], boot);
